...
<table class="zebra-striped halfwidthcontainer">
    <tr>
...
{if $withdrawlevel}
<p align="center">
  <input type="button" class="btn large primary" value="{$LANG.affiliatesrequestwithdrawal}" onclick="window.location='{$smarty.server.PHP_SELF}?action=withdrawrequest'" />
</p>
{/if}
{/if}
...
<table class="zebra-striped">
    <thead>
        <tr>
            ...
            <th{if $orderby eq "billingcycle"} class="headerSort{$sort}"{/if}><a href="affiliates.php?orderby=billingcycle">{$LANG.orderbillingcycle}</a></th>
