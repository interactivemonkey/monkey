...
<div class="searchbox">
    <form method="post" action="downloads.php?action=search">
        <input type="text" name="search" value="{if $search}{$search}{else}{$LANG.downloadssearch}{/if}" class="searchinput" onfocus="if(this.value=='{$LANG.downloadssearch}')this.value=''" />
