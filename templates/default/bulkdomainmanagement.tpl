...
<p><label class="full"><input type="radio" name="nschoice" value="default" onclick="disableFields('domnsinputs',true)" checked /> {$LANG.nschoicedefault}</label><br />
<label class="full"><input type="radio" name="nschoice" value="custom" onclick="disableFields('domnsinputs','')" checked /> {$LANG.nschoicecustom}</label></p>
                ...
                <fieldset>
                    ...
                    <p align="center"><input type="submit" class="btn primary large" value="{$LANG.changenameservers}" /></p>
                </fieldset>
...
<p align="center"><input type="submit" name="enable" value="{$LANG.domainsautorenewenable}" class="btn success large" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="disable" value="{$LANG.domainsautorenewdisable}" class="btn error large" /></p>
...
<p align="center"><input type="submit" name="enable" value="{$LANG.domainreglockenable}" class="btn success large" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="disable" value="{$LANG.domainreglockdisable}" class="btn error large" /></p>
...
<p><label class="full"><input type="radio" name="wc[{$contactdetail}]" id="{$contactdetail}1" value="contact" onclick="usedefaultwhois(id)" /> {$LANG.domaincontactusexisting}</label></p>
...
<p><label class="full"><input type="radio" name="wc[{$contactdetail}]" id="{$contactdetail}2" value="custom" onclick="usecustomwhois(id)" checked /> {$LANG.domaincontactusecustom}</label></p>
...
<p><input type="button" value="{$LANG.clientareabacklink}" onclick="window.location='clientarea.php?action=domains'" class="btn" /></p>
