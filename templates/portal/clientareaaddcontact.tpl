    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0">
          <tr>
            ...
            <td><input type="text" name="firstname" value="{$contactfirstname}" size="25" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientarealastname}</td>
            <td><input type="text" name="lastname" value="{$contactlastname}" size="25" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareacompanyname}</td>
            <td><input type="text" name="companyname" value="{$contactcompanyname}" size="25" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareaemail}</td>
            <td><input type="text" name="email" value="{$contactemail}" size="50" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="city" value="{$contactcity}" size="25" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareastate}</td>
            <td><input type="text" name="state" value="{$contactstate}" size="25" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareapostcode}</td>
            <td><input type="text" name="postcode" value="{$contactpostcode}" size="25" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="phonenumber" value="{$contactphonenumber}" size="25" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.subaccountactivate}</td>
          ...
          <tr class="subaccountfields"{if !$subaccount} style="display:none;"{/if}>
          ...
          <tr class="subaccountfields"{if !$subaccount} style="display:none;"{/if}>
            <td class="fieldarea">{$LANG.subaccountpermissions}</td>
            <td><input type="checkbox" name="permissions[]" id="permprofile" value="profile"{if in_array('profile',$permissions)} checked{/if} /> <label for="permprofile">{$LANG.subaccountpermsprofile}</label><br />
...
<input type="checkbox" name="permissions[]" id="permorders" value="orders"{if in_array('orders',$permissions)} checked{/if} /> <label for="permorders">{$LANG.subaccountpermsorders}</label></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareacontactsemails}</td>
            <td><input type="checkbox" name="generalemails" id="generalemails" value="1"{if $generalemails} checked{/if} />
              <label for="generalemails">{$LANG.clientareacontactsemailsgeneral}</label><br />
              <input type="checkbox" name="productemails" id="productemails" value="1"{if $productemails} checked{/if} />
              <label for="productemails">{$LANG.clientareacontactsemailsproduct}</label><br />
              <input type="checkbox" name="domainemails" id="domainemails" value="1"{if $domainemails} checked{/if} />
              <label for="domainemails">{$LANG.clientareacontactsemailsdomain}</label><br />
              <input type="checkbox" name="invoiceemails" id="invoiceemails" value="1"{if $invoiceemails} checked{/if} />
              <label for="invoiceemails">{$LANG.clientareacontactsemailsinvoice}</label><br />
              <input type="checkbox" name="supportemails" id="supportemails" value="1"{if $supportemails} checked{/if} />
              <label for="supportemails">{$LANG.clientareacontactsemailssupport}</label><br /></td>
          </tr>
      </table></td>
    </tr>
  </table>
