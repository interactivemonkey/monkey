...
<p class="heading2">{$LANG.domainmanagens}</p>
...
<p class="heading2">{$LANG.domainautorenewstatus}</p>
...
<p class="heading2">{$LANG.domainreglockstatus}</p>
...
<p class="heading2">{$LANG.domaincontactinfoedit}</p>
