...
<tr class="newccinfo"{if $clientsdetails.cclastfour && $ccinfo neq "new"} style="display:none;"{/if}><td width="100">{$LANG.creditcardcardtype}</td><td><select name="cctype">
...
{/if}
<tr><td width="100">{$LANG.creditcardcvvnumber}</td><td><input type="text" name="cccvv" value="{$cccvv}" size="5" autocomplete="off" /></td></tr>
