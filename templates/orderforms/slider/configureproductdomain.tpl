...
{if $incartdomains}
<div class="option">
<label><input type="radio" name="domainoption" value="incart" />{$LANG.cartproductdomainuseincart}</label>
...
<div class="option">
<label><input type="radio" name="domainoption" value="register" />{$LANG.cartregisterdomainchoice|sprintf2:$companyname}</label>
...
<div class="option">
<label><input type="radio" name="domainoption" value="transfer" />{$LANG.carttransferdomainchoice|sprintf2:$companyname}</label>
...
{if $owndomainenabled}
<div class="option">
<label><input type="radio" name="domainoption" value="owndomain" />{$LANG.cartexistingdomainchoice|sprintf2:$companyname}</label>
...
{if $subdomains}
<div class="option">
<label><input type="radio" name="domainoption" value="subdomain" />{$LANG.cartsubdomainchoice|sprintf2:$companyname}</label>
